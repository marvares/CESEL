...
ui <- fluidPage(
  ...
  # --- CAMPOS DE CPANEL AÑADIDOS AQUÍ ---
  hr(),
  h4("cPanel"),
  fluidRow(
...
server <- function(input, output, session) {
  ...
  columnas_nombres <- c("Nombre", "Telefono", "Email", "Fecha_Registro", "DOLO", "ID", 
                        ...
                        "cPanel_Otros_Qty", "cPanel_Otros_Desc") # Nuevas columnas cPanel
  ...
  # Función para limpiar todos los campos (incluyendo los nuevos)
  clear_fields <- function() {
    ...
    updateNumericInput(session, "cpanel_economie", value = 0); updateNumericInput(session, "cpanel_deluxe", value = 0)
    updateNumericInput(session, "cpanel_ultimate", value = 0); updateNumericInput(session, "cpanel_otros_qty", value = 0)
  ...
  observeEvent(input$modify_button, {
    ...
    updateNumericInput(session, "cpanel_economie", value = fila_datos$cPanel_Economie)
    updateNumericInput(session, "cpanel_deluxe", value = fila_datos$cPanel_Deluxe)
    updateNumericInput(session, "cpanel_ultimate", value = fila_datos$cPanel_Ultimate)
    updateNumericInput(session, "cpanel_otros_qty", value = fila_datos$cPanel_Otros_Qty)
    updateTextInput(session, "cpanel_otros_desc", value = fila_datos$cPanel_Otros_Desc)
