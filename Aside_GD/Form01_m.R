...
ui <- fluidPage(
  ...
  # --- CAMPOS CONDICIONALES AÑADIDOS AQUÍ ---
  shinyjs::hidden(
  ...
  # ... (resto de las secciones de productos)
  hr(),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$new_sale, {
    if (input$new_sale == "Yes") shinyjs::show("new_sale_details")
    else shinyjs::hide("new_sale_details")
  }, ignoreNULL = FALSE)
  
  observeEvent(input$new_sale_currency, {
    if (input$new_sale_currency == "Otro") shinyjs::show("new_sale_currency_otro")
    else shinyjs::hide("new_sale_currency_otro")
  }, ignoreNULL = FALSE)
