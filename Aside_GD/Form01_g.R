...
server <- function(input, output, session) {
  ...
  columnas_nombres <- c("Nombre", "Telefono", "Email", "Fecha_Registro", "DOLO", "ID", "Sexo",
                        ...
                        "cPanel_Economie", "cPanel_Deluxe", "cPanel_Ultimate", 
                        "cPanel_Otros_Qty", "cPanel_Otros_Desc",
  ...
  clear_fields <- function() {
    ...
    updateRadioButtons(session, "sexo", selected = "Masculino") # Resetear Sexo
    ...
    # ... (resto de resets de numericInputs)
    ...
    updateNumericInput(session, "cpanel_economie", value = 0); updateNumericInput(session, "cpanel_deluxe", value = 0); updateNumericInput(session, "cpanel_ultimate", value = 0); updateNumericInput(session, "cpanel_otros_qty", value = 0)
    updateTextInput(session, "cpanel_otros_desc", value = "")
    updateNumericInput(session, "ssl_standard", value = 0); updateNumericInput(session, "ssl_gere", value = 0)
    updateNumericInput(session, "ssl_otro_qty", value = 0); updateTextInput(session, "ssl_otro_desc", value = "")
  }
  ...
  observeEvent(input$submit, {
    nuevo_registro <- data.frame(
      ...
      cPanel_Economie = input$cpanel_economie, cPanel_Deluxe = input$cpanel_deluxe,
      cPanel_Ultimate = input$cpanel_ultimate, cPanel_Otros_Qty = input$cpanel_otros_qty,
      cPanel_Otros_Desc = input$cpanel_otros_desc,
      SSL_Standard = input$ssl_standard, SSL_Gere = input$ssl_gere,
      SSL_Otro_Qty = input$ssl_otro_qty, SSL_Otro_Desc = input$ssl_otro_desc,
  ...
  observeEvent(input$modify_button, {
    ...
    updateRadioButtons(session, "sexo", selected = fila_datos$Sexo) # Cargar Sexo
    # ... (resto de updates)
    updateNumericInput(session, "dominios_com", value = fila_datos$Dominios_com); updateNumericInput(session, "dominios_ca", value = fila_datos$Dominios_ca); updateNumericInput(session, "dominios_otros", value = fila_datos$Dominios_otros)
    updateNumericInput(session, "ms365_ee", value = fila_datos$MS365_EE); updateNumericInput(session, "ms365_ep", value = fila_datos$MS365_EP); updateNumericInput(session, "ms365_bol", value = fila_datos$MS365_BOL); updateNumericInput(session, "ms365_bp", value = fila_datos$MS365_BP); updateNumericInput(session, "ms365_be", value = fila_datos$MS365_BE); updateNumericInput(session, "ms365_ees", value = fila_datos$MS365_EES); updateNumericInput(session, "ms365_eps", value = fila_datos$MS365_EPS); updateNumericInput(session, "ms365_bols", value = fila_datos$MS365_BOLS); updateNumericInput(session, "ms365_bps", value = fila_datos$MS365_BPS); updateNumericInput(session, "ms365_bes", value = fila_datos$MS365_BES)
    updateNumericInput(session, "wam_basic", value = fila_datos$WAM_Basic); updateNumericInput(session, "wam_standard", value = fila_datos$WAM_Standard); updateNumericInput(session, "wam_premium", value = fila_datos$WAM_Premium); updateNumericInput(session, "wam_ec", value = fila_datos$WAM_EC)
    updateNumericInput(session, "wp_basic", value = fila_datos$WP_Basic); updateNumericInput(session, "wp_deluxe", value = fila_datos$WP_Deluxe); updateNumericInput(session, "wp_ultimate", value = fila_datos$WP_Ultimate)
    updateNumericInput(session, "cpanel_economie", value = fila_datos$cPanel_Economie); updateNumericInput(session, "cpanel_deluxe", value = fila_datos$cPanel_Deluxe); updateNumericInput(session, "cpanel_ultimate", value = fila_datos$cPanel_Ultimate); updateNumericInput(session, "cpanel_otros_qty", value = fila_datos$cPanel_Otros_Qty); updateTextInput(session, "cpanel_otros_desc", value = fila_datos$cPanel_Otros_Desc)
    updateNumericInput(session, "ssl_standard", value = fila_datos$SSL_Standard); updateNumericInput(session, "ssl_gere", value = fila_datos$SSL_Gere); updateNumericInput(session, "ssl_otro_qty", value = fila_datos$SSL_Otro_Qty); updateTextInput(session, "ssl_otro_desc", value = fila_datos$SSL_Otro_Desc)
  ...
  observeEvent(input$update, {
    ...
    valores$df[fila, ] <- list(
      input$nombre, input$telefono, input$email, as.character(input$fecha_registro), input$DOLO, input$ID,
      input$sexo,
      ...
      input$cpanel_economie, input$cpanel_deluxe, input$cpanel_ultimate,
      input$cpanel_otros_qty, input$cpanel_otros_desc,
